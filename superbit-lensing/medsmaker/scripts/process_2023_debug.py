...
from superbit-lensing.medsmaker.superbit import medsmaker_real as medsmaker
from superbit-lensing.medsmaker.superbit.hotcold_sextractor import HotColdSExtractor
import yaml
import pdb
...
def main(args):
    ...
    for band in bands:
        ...
        logprint('Grabbing PSF models... \n')
        bm.set_psfex_model_files(use_coadd=use_coadd)
