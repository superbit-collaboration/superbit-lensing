...
class AnnularCatalog():
    ...
    def _compute_metacal_quantities(self):
        ...
        # PSF response/bias terms only exist when the reconvolution kernel is
        # 'dilate' (the '*_psf' shear types are present in the mcal catalog).
        ...
        # PSF response/bias only available for the 'dilate' kernel
        c_total = c_gamma
        if has_psf:
