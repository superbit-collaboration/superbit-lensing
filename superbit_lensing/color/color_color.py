...
def main(args):
    ...
    file_b = f"{base_path}/b/coadd/{cluster_name}_coadd_b.fits"
    file_g = f"{base_path}/g/coadd/{cluster_name}_coadd_g.fits"
    file_u = f"{base_path}/u/coadd/{cluster_name}_coadd_u.fits"
